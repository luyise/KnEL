...
let add_edge g id1 id2 =
  let n1 = try node_for_label g id1 with Not_found -> print_endline (id1^" "^id2); assert false in
  let n2 = try node_for_label g id2 with Not_found -> print_endline (id1^" "^id2); assert false in
